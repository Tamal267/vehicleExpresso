...
const CareUser = () => {
    ...
    //const notify =(notif)=>toast.success(notif);
    const warning =(notif)=>toast.error(notif);
      ...
      const insertData = async () => {
        try {
          ...
          //(`Hello ${user.name}! Plz collect your Service token : ${jsonData.service_id}`);
        }catch(err){
      ...
      <div className="user">
        ...
        {visible1 && !exit1 && (
          <form className="popup">
            <button className="exit" onClick={HandleLongExit}></button>
            <fieldset>
              ...
              <button type="submit" className="submit" onClick={HandleLongSubmit}></button>
            </fieldset>
          </form>
        )}
        {visible2 && !exit2 && (
          <form className="popup">
          <button className="exit" onClick={HandleShortExit}></button>
          <fieldset>
            <legend>SHORTTERM CARE</legend>
            <legend>ENTER YOUR VEHICLE INFO</legend>
            <div className="block">
            ...
            <button type="submit" className="submit" onClick={HandleShortSubmit}></button>
          </fieldset>
        </form>
        )}
        <div>
...
<li>
  <br></br>
  <h3>SHORTTERM CARE</h3>
  <h3>ENTER YOUR VEHICLE INFO </h3>
  <div className="block">
    <h3>Vehicle Type:</h3>
    <input type="text"/>
  </div>
  ...
  <div className="block">
    <h3>Service ID:</h3>
    <input type="text" placeholder="(For Old Customers)"/>
  </div>
  <h3>ENTER YOUR DESIRED SERVICE</h3>
  <div className="check">
    <input type="checkbox" />
